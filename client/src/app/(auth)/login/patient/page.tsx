...
function page() {
  ...
  return (
    <div className="flex h-screen ">
      ...
      <div className=" hidden md:inline-block w-[80%]">
        <Image
          src="https://i.pinimg.com/1200x/5c/4a/b5/5c4ab54f5e0d8b438d07d7375c997560.jpg"
          alt="Doctor"
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <form className="md:w-96 w-80 flex flex-col items-center justify-center">
          <h2 className="text-4xl text-gray-900 font-medium">
            {isSignup ? "Sign up" : "Sign in "} (Patient)
          </h2>
          ...
          <button
            type="button"
            onClick={() => callGoogleLoginApi("patient")}
  ...
  <div className="relative w-full">
    <input
      ...
      className="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-11 pl-3 pr-10"
      required
    />
          ...
          <button
            ...
            onClick={async (e) => {
              ...
              if (isSignup) {
                ...
                await handlePatientLogin(email, password, router, showToast);
              }
            }}
